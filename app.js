...
*/
const my3FavoriteTVShows = ['lucifer', 'The Walking Dead', 'Spartacus'];
const sentence = 'minhas 3 series favoritas são: SÉRIE_01, SÉRIE_02 e SÉRIE_03.';
...
/*
  ...
  - Exiba no console um boolean indicando se o array de séries que você criou  
    possui 3 itens.
*/
const isRandomTVShowIncluded = 'lucifer'
...
const randomTVShow = 'spartacus'
console.log(isRandomTVShowIncluded.length)
